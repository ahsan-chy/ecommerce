...
const ConfirmConstruct = (props: { handleActive: any; selectedCollections: any }) => {
  ...
  return (
    <>
            ...
            <motion.div
              ...
              <div className="right-content-wrapper">
                <div className="right-form">
                  ...
                  <div className="project-row project-second">
                    <p>Nickname</p>
      ...
      <div className="footer-vote-wrapper">
        <h3>
          To Vote
          <img src={ArrowWhite} alt="" />
        </h3>
